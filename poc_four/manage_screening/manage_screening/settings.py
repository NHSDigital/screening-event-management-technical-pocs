"""
Django settings for manage_screening project.
...
SECRET_KEY = 'django-insecure-nb725j1h2+d@bumy$q_07*2#a0v$!6n4zod(lb(@9jjww6g9b1'
...
WSGI_APPLICATION = 'manage_screening.wsgi.application'
